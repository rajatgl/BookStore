...
import com.bridgelabz.bookstore.database.mysql.tables.MySqlWishListTable

import scala.concurrent.Future

class MySqlWishListTableById(tableName : String,tableNameForUser: String)
  extends MySqlWishListTable(tableName,tableNameForUser)
  with ICrudRepository[MySqlWishList]{
  /**
   *
   ...
   */
  override def read(identifier: Any, fieldName: String): Future[Seq[MySqlWishList]] = {
